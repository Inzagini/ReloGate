...
const tavily_js_1 = require("../services/tavily.js");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
exports.chatRouter = (0, express_1.Router)();
const GEMINI_API_KEY = process.env.GEMINI_API_KEY;
exports.chatRouter.post('/api/chat', async (req, res) => {
...
5. If the user asks general or specific questions about the relocation steps, answer them using facts.`;
    ...
    try {
        ...
        if (needsSearch) {
            ...
            groundingContext = await (0, tavily_js_1.searchTavily)(lastUserMessage);
        }
...
function streamMockResponse(messages, profile, res) {
