...
exports.formRouter.post('/api/form/fill', async (req, res) => {
    const { paymentToken, profile } = req.body;
    if (!paymentToken) {
    ...
    try {
        ...
        const drawHeader = () => {
            ...
            page.drawRectangle({
                ...
                width: 595.28,
                height: 52,
                color: (0, pdf_lib_1.rgb)(0.11, 0.16, 0.29), // #1c294a Dark blue
            });
        ...
        const writeSectionTitle = (title) => {
            page.drawRectangle({
                ...
                width: 515.28,
                height: 20,
                color: (0, pdf_lib_1.rgb)(0.9, 0.93, 0.96),
            });
            page.drawText(title, {
                x: 48,
                y: yPos,
                size: 11,
                font: fontBold,
                color: (0, pdf_lib_1.rgb)(0.2, 0.25, 0.35),
            });
            yPos -= 35;
        };
